...
|---|---|---|
| `gamemaster` | `/s/gamemaster/` | `dobot-mg400-relay`, `webcam`, `playfield-areas`, `pickup-game`, `atom-manager`, `joint-angles-test`, `cartesian-xyz-test` |
| `green` | `/s/green/` | `pickup-game`, `game-link`, `joint-angles-test`, `cartesian-xyz-test`, `playfield-areas` |
| `purple` | `/s/purple/` | `pickup-game`, `game-link`, `joint-angles-test`, `cartesian-xyz-test`, `playfield-areas` |
