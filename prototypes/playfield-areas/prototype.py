...
camera). Three pages talk to it:
  ...
  * game.html       — a 90 second webcam view that confirms the tag deposit
                      against two shared playfield areas.
...
MANIFEST = {
    ...
    "pages": [
        ...
        {"path": "game", "label": "Tag game screen ↗", "newtab": True},
    ],
}
...
def _seed():
    """Starter areas for the tag game on a first-ever run."""
    global _next_id
    presets = [
        {
            "name": "pickup", "x": -6.4, "z": 0.0, "size": 3.0,
            "color": "#4f9dff", "glow": 1.9, "marker": 0,
            "show_area": True, "show_aruco": False, "show_links": False,
        },
        {
            "name": "deposit", "x": 5.4, "z": 0.0, "size": 3.0,
            "color": "#35d07f", "glow": 2.3, "marker": 0,
            "show_area": True, "show_aruco": False, "show_links": False,
        },
    ]
    for p in presets:
